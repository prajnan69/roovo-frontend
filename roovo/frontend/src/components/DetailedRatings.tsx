...
export default function DetailedRatings({ ratings }: any) {
  const isTopTier = Object.values(ratings.detailedRatings).every(
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {Object.entries(ratings.detailedRatings).map(([key, value]: [string, any]) => (
